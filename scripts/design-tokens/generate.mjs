 ...
 *
 * T1 emitted the two web surfaces; T2 adds the two Go surfaces (the shared
 * internal/designtokens package + the share-page tokens.gohtml). Mobile
 * (Swift/Kotlin) emitters land in a follow-up slice. Every emitter reads the
 * SAME tokens.json and the SAME statusBuckets map, which is why the generator
 * lives at the repo root rather than under web/.
 */
