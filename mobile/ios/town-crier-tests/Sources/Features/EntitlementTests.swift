...
struct EntitlementTests {
  ...
  func allCasesDefined() {
    ...
    #expect(allCases.contains(.searchApplications))
  ...
  func displayNames() {
    #expect(Entitlement.searchApplications.displayName == "Search Applications")
  ...
  func identifiable() {
    let entitlement = Entitlement.searchApplications
